# v14 `run_test.sh` Quick Guide

The wrapper converts short operator commands into the full v14 `ipsec_app` command line while preserving the existing validated test path.
